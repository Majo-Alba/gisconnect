...
// // Ok so going step by step, for setp 1) Extend the Order model (Mongo), help be verify if this is the right place where order schema lives (orderModel.js) and, if so, can you help me direct edit to avoid removing/modifying important things? 
