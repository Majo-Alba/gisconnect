...
// // Facing the following situations: 1) when editing, I'm allowed to edit but when I click "Guardar", though I am shown the message "Dirección actualizada" nothing changes in my backend. 2) Nothing happens when I click on the star for "predeterminada"
// import { useEffect, useMemo, useState } from "react";
// import { useNavigate } from "react-router-dom";
// import axios from "axios";
...
//   // Inline edit states
//   const [editId, setEditId] = useState(null); // _id currently editing
//   const [editType, setEditType] = useState(null); // "shipping" | "billing"
//   const [form, setForm] = useState({}); // holds current editable fields
...
//       // Send ONLY model-specific fields to avoid mixing
//       const payload =
//         editType === "shipping"
//           ? {
//               apodo: form.apodo,
...
//       // If set as default: unset others on server best-effort
//       if (payload.isDefault) {
//         const list = editType === "shipping" ? shipping : billing;
//         await Promise.all(
//           list
//             .filter((a) => a._id !== editId)
//             .map((a) =>
//               axios
//                 .patch(
//                   editType === "shipping"
...
//   // ===== CARD RENDERERS with requested button layout =====
...
//       <div
//         key={a._id}
//         className="manageAdd-AddGeneralDiv"
//         style={{ padding: 12, marginBottom: 10, position: "relative" }}
//       >
//         {/* TOP ROW: apodo + Predeterminada button */}
//         <div className="manageAdd-NicknameStarDiv">
...
//                 <input className="manageAdd-InputEditField" value={form.cpEnvio} onChange={(e)=>onChange("cpEnvio", e.target.value)} />
//             </div>
//             {/* Save/Cancel appear near bottom naturally; keep corners clean while editing */}
//             <div className="manageAdd-SaveCancelDiv">
//               <button className="manageAdd-SaveBtn" onClick={saveEdit} title="Guardar">
//                 <FontAwesomeIcon icon={faFloppyDisk} /> Guardar
//               </button>
...
//         {/* <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}> */}
//           <label className="productDetail-Label" style={{ fontWeight: 600 }}>
//             {/* {a?.apodo || a?.razonSocial || "Datos de facturación"} */}
//             {a?.razonSocial || "Datos de facturación"}
//           </label>
//           {!isEditing && (
//             <button
...
//           <>
//             <div className="manageAdd-ShippAddDiv">
//                 {/* <label className="productDetail-Label"><b>Razón Social:</b> {a?.razonSocial || "—"}</label> */}
//                 <label className="productDetail-Label"><b>RFC:</b> {a?.rfcEmpresa || "—"}</label> <br></br>
...
//       {/* MAIN */}
//       <div className="app-main">
//         <label className="sectionHeader-Label">Gestionar preferencias</label>
...
//                     value={prefCarrier}
//                     onChange={(e) => setPrefCarrier(e.target.value)}
//                   >
//                     <option value="">Selecciona...</option>
//                     <option value="DHL">DHL</option>
//                     <option value="FedEx">FedEx</option>
...
//                       type="checkbox"
//                       checked={prefInsured}
//                       onChange={(e) => setPrefInsured(e.target.checked)}
//                     />
//                     <b>¿Asegurar envío?</b>
//                   </label>
...
//       <div className="app-footer footerMenuDiv">
//         <div className="footerHolder">
//           <div className="footerIcon-NameDiv" onClick={() => navigate(-1)}>
//             <FontAwesomeIcon icon={faArrowLeft} className="footerIcons" />
//             <label className="footerIcon-Name">REGRESAR</label>
//           </div>
//         </div>
//       </div>
//     </body>
