...
export default function DeliveredOrders() {
  ...
  // ✅ NEW: detect “Recoger en Matriz” from string or object form
            ...
            return (
              <div className="existingQuote-Div" key={order._id}>
                <div className="quoteAndFile-Div" onClick={() => goToOrderSummary(order._id)}>
                  ...
                  <br />
                  <label className="productDetail-Label">
                    {/* ✅ Only change the leading word */}
                    {pickup ? "Entregado" : "Enviado"}:{" "}
                    {order.deliveryDate
...
// // in deliveredOrders.jsx, for those cases where (mongodb) "shippingInfo" is set to "Recoger en Matriz", instead of having "Enviado" followed by the date, can we change only "Enviado" to "Entregado". Here is my current deliveredOrders.jsx, please direct edit
// import { useState, useEffect, useMemo } from "react";
// import { useNavigate } from "react-router-dom";
// import axios from "axios";
