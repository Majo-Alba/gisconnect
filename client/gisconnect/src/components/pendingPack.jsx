// ✅ Updated pendingPack.jsx
// - Removed time filter UI + logic (no more hiding orders)
...
export default function PendingPack() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      // Keep only "Pago Verificado" here so this screen stays focused
  ...
  // Homologated “final USD” extraction (kept in case you need it later)
  ...
  // ✅ No time filter; always show all + sort newest first
...
// // lets do the exact same thing for pendingPack.jsx. Remove the search filter, place orders newest on top, oldest on bottom, and add auto-refresh every 30 seconds. Here is my current pendingPack.jsx, please direct edit
// import { useState, useEffect, useMemo } from "react";
// import axios from "axios";
// import { useNavigate } from "react-router-dom";
